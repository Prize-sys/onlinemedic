  ...
  return (
    <div className={aboutPage ? styles.aboutUs : styles.aboutContainer}>
      <Animated y={true} className={aboutPage ? styles.aboutUs : styles.aboutContainer}>
        { !aboutPage && <h2 className={styles.heading}>Who We Are</h2>}


        <div className={styles.contentWrapper}>
          <div className={styles.image}>
            <img src={aboutImg} alt="Who We Are" className={styles.aboutImage} />
          </div>
          ...
          <div className={styles.text}>
            ...
            <Link to="about">
              <button className={`button ${styles.readMoreLink}`}>Explore More</button>
            </Link>
          </div>}
